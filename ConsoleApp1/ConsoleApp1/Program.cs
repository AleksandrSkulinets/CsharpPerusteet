...
namespace Opetuspäivä4Teoria
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //{
            //    case 0:
            //        Console.WriteLine($"{UserNumber} on parilinen");
            //        break;
            //    //case 1:
            //    default:
            //        Console.WriteLine($"{UserNumber} on pariton");
            //        break;
            //}
            //Console.Write("Anna luku : ");
            //int UserNumber = int.Parse(Console.ReadLine());
            //                                          // true                          // false
            //string message = (UserNumber % 2 == 0) ? $"{UserNumber} on parillinen" : $"{UserNumber} on pariton";
